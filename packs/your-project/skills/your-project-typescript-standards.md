---
name: your-project-typescript-standards
description: TypeScript coding standards. Loaded by Surgeon when task Layer = TypeScript or as a baseline alongside framework skills (React, Angular, Vue). Covers strict-mode flags, `interface` vs `type`, generics, narrowing, and the patterns that catch bugs at compile time. Layer this on top of your-project-javascript-standards.md.
---
...
This is **layered on top** of `your-project-javascript-standards.md`. Everything in the JS skill applies; this one adds the type-system bits.
