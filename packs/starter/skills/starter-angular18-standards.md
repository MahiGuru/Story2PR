---
name: starter-angular18-standards
description: Angular 18 coding standards. Loaded by Surgeon when task Layer = Frontend/Angular18. Covers NgModule-based features, RxJS, NgRx, reactive forms, and the conventions an Angular 18 codebase typically settles on. SEPARATE from starter-angular19-standards.md (standalone components, signals).
---
...
This skill covers an **Angular 18** frontend that uses **NgModule-based** feature organization. Angular 18 is the last major release before **standalone components became the default** in Angular 19; if your project has migrated to standalone, use `starter-angular19-standards.md` instead.
