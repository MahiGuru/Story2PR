...
- Bundle mode is handled by the dedicated `bundle-ship.md` agent (self-contained). This file refuses to handle bundle context — see `bundle_context_guard (0d)`. Single-story / bug is the only scope of this file.
