...
Per-ticket files already on disk:
  ...
  • PROJ-2345.md           (mode: bundle-card, parent bundle: iiqmag-100-bundle-a3f2)
  • PROJ-3432.md           (mode: bundle-card, parent bundle: iiqmag-100-bundle-a3f2)
  • PROJ-23433-lld.md      (mode: bundle-card-lld)
  • (PROJ-2233 — no prior file)

Overlapping bundles in progress / archived:
  • iiqmag-100-bundle-a3f2  (5 tickets, last activity 2026-05-01)
  ...
  • iiqhar-77-bundle-c2e9   (3 tickets, last activity 2026-03-19)
...
4. Extract bundle config:
   ...
   - `{jira_labels_config}`     ← `runtime.bundle.jira_labels` block (default: enabled, prefix `iiq_agentic_team_bulk`, mode `all_tickets`, apply_at `both`, include_review_only=true, include_skipped_by_evidence=false). See `agent-flow.mdc § JIRA labels for bundle correlation`. Used by C.3 (preview), C.4.5 (early apply), and ship Phase 6 (re-apply).
...
stages:
  orchestrator:
    ...
    labels_applied:                     # NEW — set by C.4.5 apply_bundle_labels
      PROJ-1234: [iiq_agentic_team_bulkPROJ-1234, iiq_agentic_team_bulkPROJ-2345, iiq_agentic_team_bulkPROJ-3432]
      PROJ-2345: [iiq_agentic_team_bulkPROJ-1234, iiq_agentic_team_bulkPROJ-2345, iiq_agentic_team_bulkPROJ-3432]
      PROJ-3432: [iiq_agentic_team_bulkPROJ-1234, iiq_agentic_team_bulkPROJ-2345, iiq_agentic_team_bulkPROJ-3432]
...
prefix = jira_labels_config.prefix                           # default "iiq_agentic_team_bulk"
