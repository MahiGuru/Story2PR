...
grep -rl $GREP_EXCLUDE_FLAGS "sailpoint\|SailPoint\|IdentityIQ" --include="*.java" --include="*.xml" | head -1 && echo "SailPoint IIQ"
...
|-----------|---------|-----------------|------------|
| Oracle 19c | Primary database | iiq.properties | jdbc:oracle:thin:@... |
...
**DB connection configured:**
  Primary:  Oracle (via iiq.properties jdbc.url)
...
FRAMEWORK_COVERAGE_HINTS:
  Angular18:
    ...
    reference_skill: starter-angular18-standards.md
  ...
  Angular19:
    ...
    reference_skill: starter-angular19-standards.md
  ...
  React:
    ...
    reference_skill: starter-react-standards.md
  ...
  Vue3:
    ...
    reference_skill: starter-vue3-standards.md
  ...
  Spring Boot:
    ...
    reference_skill: starter-java-standards.md (extend or split out)
...
1. Layer:    Frontend/Angular19
   ...
   Suggested coverage:
     ...
     • New control flow (@if, @for, @switch)
     • Zoneless change detection (if enabled)
   Reference:  packs/starter/skills/starter-angular19-standards.md
...
2. Layer:    Backend/Java (Spring Boot 3 detected)
   ...
   Suggested coverage (Spring Boot extension):
     ...
     • jakarta.* imports (Spring Boot 3 — NOT javax.*)
     • Exception handling via @ControllerAdvice
   Reference:  packs/starter/skills/starter-java-standards.md
...
3. Layer:    Backend/Database (PostgreSQL 15 detected)
   ...
   Suggested coverage:
     ...
     • Migration tooling (Flyway / Liquibase / Alembic / Prisma)
     • JSONB usage rules (when to denormalize vs proper relational)
   Reference:  none in starter pack — write fresh
...
2. **Reference the starter pack when relevant.** If a comparable skill exists in `packs/starter/skills/`, link it as a reference for the user to copy and adapt.
